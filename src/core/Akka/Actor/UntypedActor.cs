...
namespace Akka.Actor
{
    ...
    public abstract class UntypedActor : ActorBase
    {
        ...
        /// <summary>
        /// Returns this UntypedActor's IUntypedActorContext. The <see cref="IUntypedActorContext"/> is 
        /// not thread safe so do not expose it outside of the <see cref="UntypedActor"/>.
        /// </summary>
