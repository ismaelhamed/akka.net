...
namespace Akka.Util.Collections.Concurrent.Locks
{
    ...
    public class ReentrantLock : ILock
    {
        ...
        protected ICollection<Thread> QueuedThreads
        {
            get { return sync.QueuedThreads; }
        }

        public bool HasWaiters(ICondition condition)
        {
            if (condition == null)
            {
        ...
        public int GetWaitQueueLength(ICondition condition)
        {
            if (condition == null)
            {
                throw new NullReferenceException();
        ...
        public ICollection<Thread> GetWaitingThreads(ICondition condition)
        {
            if (condition == null)
            {
                throw new NullReferenceException();
